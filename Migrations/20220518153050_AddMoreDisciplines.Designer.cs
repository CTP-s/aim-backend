...
namespace aim_backend.Migrations
{
    ...
    [Migration("20220518153050_AddMoreDisciplines")]
    partial class AddMoreDisciplines
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aim_backend.Models.Course", b =>
                {
                    b.HasOne("aim_backend.Models.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("aim_backend.Models.Enrollment", b =>
                {
                    b.HasOne("aim_backend.Models.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("aim_backend.Models.Grade", b =>
                {
                    b.HasOne("aim_backend.Models.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("aim_backend.Models.StudentCurriculum", b =>
                {
                    b.HasOne("aim_backend.Models.Curriculum", "Curriculum")
                        .WithMany()
                        .HasForeignKey("curriculumId");

                    b.HasOne("aim_backend.Models.OptionalCourse", "OptionalCourse")
                        .WithMany()
